...
async def test_twenty_auction_record(ctx, members):
    ...
    lolpark.auction_dict['2팀']['탑'] = (members[5], -1)
    lolpark.auction_dict['2팀']['정글'] = (members[6], 10)
    lolpark.auction_dict['2팀']['미드'] = (members[7], 20)
    lolpark.auction_dict['2팀']['원딜'] = (members[8], 30)
    lolpark.auction_dict['2팀']['서폿'] = (members[9], 40)
    lolpark.auction_dict['3팀']['탑'] = (members[10], -1)
    lolpark.auction_dict['3팀']['정글'] = (members[11], 10)
    lolpark.auction_dict['3팀']['미드'] = (members[12], 20)
    lolpark.auction_dict['3팀']['원딜'] = (members[13], 30)
    lolpark.auction_dict['3팀']['서폿'] = (members[14], 40)
    lolpark.auction_dict['4팀']['탑'] = (members[15], -1)
    lolpark.auction_dict['4팀']['정글'] = (members[16], 10)
    lolpark.auction_dict['4팀']['미드'] = (members[17], 20)
    lolpark.auction_dict['4팀']['원딜'] = (members[18], 30)
    lolpark.auction_dict['4팀']['서폿'] = (members[19], 40)
