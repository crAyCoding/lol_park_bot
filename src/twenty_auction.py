...
async def test_twenty_auction_record(ctx, members):
    ...
    lolpark.auction_dict['1팀']['탑'] = (Summoner(members[0]), -1)
    lolpark.auction_dict['1팀']['정글'] = (Summoner(members[1]), 10)
    lolpark.auction_dict['1팀']['미드'] = (Summoner(members[2]), 20)
    lolpark.auction_dict['1팀']['원딜'] = (Summoner(members[3]), 30)
    lolpark.auction_dict['1팀']['서폿'] = (Summoner(members[4]), 40)
    lolpark.auction_dict['2팀']['탑'] = (Summoner(members[5]), -1)
    lolpark.auction_dict['2팀']['정글'] = (Summoner(members[6]), 10)
    lolpark.auction_dict['2팀']['미드'] = (Summoner(members[7]), 20)
    lolpark.auction_dict['2팀']['원딜'] = (Summoner(members[8]), 30)
    lolpark.auction_dict['2팀']['서폿'] = (Summoner(members[9]), 40)
    lolpark.auction_dict['3팀']['탑'] = (Summoner(members[10]), -1)
    lolpark.auction_dict['3팀']['정글'] = (Summoner(members[11]), 10)
    lolpark.auction_dict['3팀']['미드'] = (Summoner(members[12]), 20)
    lolpark.auction_dict['3팀']['원딜'] = (Summoner(members[13]), 30)
    lolpark.auction_dict['3팀']['서폿'] = (Summoner(members[14]), 40)
    lolpark.auction_dict['4팀']['탑'] = (Summoner(members[15]), -1)
    lolpark.auction_dict['4팀']['정글'] = (Summoner(members[16]), 10)
    lolpark.auction_dict['4팀']['미드'] = (Summoner(members[17]), 20)
    lolpark.auction_dict['4팀']['원딜'] = (Summoner(members[18]), 30)
    lolpark.auction_dict['4팀']['서폿'] = (Summoner(members[19]), 40)
