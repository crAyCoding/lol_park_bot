...
async def test_twenty_auction_record(ctx, members):
    # 경매 dict
    lolpark.auction_dict = {f'{i}팀': {line: None for line in lolpark.line_names} for i in range(1, 5)}
    remain_scores = [70, 0, 140, 70]
    lolpark.twenty_final_teams = []

    lolpark.auction_dict['1팀']['탑'] = (Summoner(members[0]), 100)
    lolpark.auction_dict['1팀']['정글'] = (Summoner(members[1]), 0)
    lolpark.auction_dict['1팀']['미드'] = (Summoner(members[2]), 90)
    lolpark.auction_dict['1팀']['원딜'] = (Summoner(members[3]), 110)
    lolpark.auction_dict['1팀']['서폿'] = (Summoner(members[4]), -1)
    lolpark.auction_dict['2팀']['탑'] = (Summoner(members[5]), 110)
    lolpark.auction_dict['2팀']['정글'] = (Summoner(members[6]), 190)
    lolpark.auction_dict['2팀']['미드'] = (Summoner(members[7]), 0)
    lolpark.auction_dict['2팀']['원딜'] = (Summoner(members[8]), 90)
    lolpark.auction_dict['2팀']['서폿'] = (Summoner(members[9]), -1)
    lolpark.auction_dict['3팀']['탑'] = (Summoner(members[10]), 50)
    lolpark.auction_dict['3팀']['정글'] = (Summoner(members[11]), 100)
    lolpark.auction_dict['3팀']['미드'] = (Summoner(members[12]), 110)
    lolpark.auction_dict['3팀']['원딜'] = (Summoner(members[13]), 0)
    lolpark.auction_dict['3팀']['서폿'] = (Summoner(members[14]), -1)
    lolpark.auction_dict['4팀']['탑'] = (Summoner(members[15]), 0)
    lolpark.auction_dict['4팀']['정글'] = (Summoner(members[16]), 80)
    lolpark.auction_dict['4팀']['미드'] = (Summoner(members[17]), 50)
    lolpark.auction_dict['4팀']['원딜'] = (Summoner(members[18]), 200)
    lolpark.auction_dict['4팀']['서폿'] = (Summoner(members[19]), -1)
